...
write_data_dir = Path("wsc_waveforms_no_resampling/")
edf_files = glob.glob('wsc/polysomnography/*/*.edf')
...
def main_function(file, frequency=None, write_data_dir=write_data_dir):
    try:
        _ = edf_signals_to_zarr(file, frequency=frequency, write_data_dir=write_data_dir, hyp_epoch_length=1)
