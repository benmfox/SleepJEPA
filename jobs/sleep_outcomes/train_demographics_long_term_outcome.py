import torch, pandas as pd, os, re, glob, lightning.pytorch as pl
import yaml
from sleepjepa.survival import SurvivalDemo
...
config_path = 'config/train_demographics_long_term_outcome.yaml'
...
n_demographic_embeddings = config['dataset']['demographic_embeddings']
y_demographic_columns = config['dataset']['y_demographic_columns']
...
if config['run_config']['do_train']:
    ...
    sub_dir = outcome_paths[outcome_cols[0]]['demographics_only_best_path']
...
if __name__ == "__main__":
    ...
    patchmeup_model = SurvivalDemo(learning_rate=config['optimizer']['learning_rate'],
    ...
    patchmeup_model = SurvivalDemo.load_from_checkpoint(best_model_path, map_location='cpu')
