...
write_data_dir = Path("apples_waveforms_no_resampling/")
hyp_data_dir = Path("apples_waveforms_no_resampling/hypnogram_csvs/")
edf_files = glob.glob('/apples/polysomnography/*/*.edf')
